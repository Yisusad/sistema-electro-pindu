...
<html>
    ...
    <body>
        ...
        <header>
            <div id="logo">
                <img src="img/logo2.png" alt="ElectroPindu" id="imagen">
            </div>
            <div id="datos">
                <p id="encabezado">
                    <b>Electro Pindu</b><br>Avda. Osvaldo Tischler y Carlos Reverchon   Hohenau, Paraguay<br>Telefono:(+595)775-232874<br>Email:ventas@electropindu.com
                </p>
            </div>
            <div id="fact">
                <p>FACTURA</p>
                <p>{{$v->serie_comprobante}}-{{$v->num_comprobante}}</p>
            </div>
        </header>
        <br>
        <section>
