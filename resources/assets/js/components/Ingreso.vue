                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <select class="form-control col-md-3" v-model="criterio">
                                      <option value="tipo_comprobante">Tipo de Venta</option>
    ...
    export default {
        ...
        methods : {
            ...
            validarIngreso(){
                ...
                if (this.tipo_comprobante==0) this.errorMostrarMsjIngreso.push("Seleccione el Tipo de Venta");
